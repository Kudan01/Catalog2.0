...
class FolderBrowseDiagnosticsTests(unittest.TestCase):
    ...
    def test_diagnostics_preserve_results_and_distinguish_root_and_folder(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(0, child_metrics["source_root_status_checks"])
            ...
            self.assertEqual(0, child_metrics["folder_fs_checks"])
            self.assertEqual(0.0, child_metrics["folder_fs_status_ms"])
